...
//! - The write log env var is renamed `PIR_TUI_WRITE_LOG` (ADR-0001; upstream
...
/// `PI_TUI_WRITE_LOG` (terminal.ts:112) — Pir rename (ADR-0001), mirrored
/// from `pir::core::environment::ENV_TUI_WRITE_LOG` (pir-tui cannot depend
/// on pir, coding-standards §2.2).
const ENV_TUI_WRITE_LOG: &str = "PIR_TUI_WRITE_LOG";
