...
//!   `PIR_CACHE_RETENTION` (requirements §5.5).
...
/// `resolveCacheRetention`. Defaults to "short"; the `PIR_CACHE_RETENTION`
...
pub(crate) mod tests {
    ...
    fn test_build_params_oauth_system_and_identity() {
        ...
        ctx.system_prompt = Some("You are pir.".to_owned());
        ...
        assert_eq!(system[1]["text"], json!("You are pir."));
