...
//!   pir adapters construct [`ProviderErrorInfo`] from reqwest responses.
...
/// Error info extracted from a failed provider HTTP request (the pir analogue
...
/// SDK-level retries disabled (pir adapters do not enable reqwest retries).
