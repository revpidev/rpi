...
use pir_ai::models::{CreateModelsOptions, Models};
use pir_ai::providers::amazon_bedrock::amazon_bedrock_provider;
use pir_ai::providers::anthropic::anthropic_provider;
use pir_ai::providers::azure_openai_responses::azure_openai_responses_provider;
use pir_ai::providers::google::google_provider;
use pir_ai::providers::google_vertex::google_vertex_provider;
use pir_ai::providers::mistral::mistral_provider;
use pir_ai::providers::openai::openai_provider;
use pir_ai::providers::openai_codex::openai_codex_provider;
...
fn test_anthropic_factory_config() {
    ...
    // Upstream wires `lazyOAuth(loadAnthropicOAuth)`; pir has no bundle
...
async fn test_google_vertex_login_flows() {
    ...
    let credential = pir_ai::auth::ApiKeyCredential {
        key: None,
        env: Some(env),
    };
    let result = auth
