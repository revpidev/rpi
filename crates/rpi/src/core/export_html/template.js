    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="rpi-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="rpi-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'rpi-share:v1:sidebar-width';
