...
use rpi_ai::models::models_are_equal;
use rpi_ai::types::{Model, ModelThinkingLevel};
...
mod tests {
    ...
    const ENV_KEY: &str = "RPI_TEST_MODEL_SELECTOR_KEY";
    ...
    const MODELS_JSON: &str = r#"{"providers": {
        "alpha": {
            ...
            "apiKey": "RPI_TEST_MODEL_SELECTOR_KEY",
    ...
    fn tui() -> TuiHandle {
        TuiHandle::from_main(TuiMainScreen::new(Box::new(
