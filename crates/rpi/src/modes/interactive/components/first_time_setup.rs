...
//!   [`rpi_tui::components::select_list::SelectList`] (per the local spec)
...
//! - The analytics copy says "rpi" instead of "Pi"
...
//!   but have no sending logic in rpi).
            ...
            SetupStep::Analytics => {
                ...
                lines.extend(
                    Text::new(
                        self.theme.fg(
                            "muted",
                            "Opting in stores a tracking identifier in settings.json and enables anonymous\nusage analytics. This helps us to better debug, reproduce, and resolve issues\nand bugs within rpi. You can observe what is shared using /privacy and make\nchanges anytime in settings.json.",
                        ),
                        1,
                        0,
                        None,
