...
//! - The keybindings manager is read from the rpi-tui global registry
...
impl CustomEditor {
    ...
    pub fn set_autocomplete_provider(
        &mut self,
        provider: Arc<dyn rpi_tui::autocomplete::AutocompleteProvider>,
    ) {
    ...
    pub fn set_on_submit(&mut self, callback: Option<rpi_tui::components::editor::SubmitFn>) {
        self.editor.on_submit = callback;
    }

    /// Change callback (delegates to the base editor's `onChange` field).
    pub fn set_on_change(&mut self, callback: Option<rpi_tui::components::editor::ChangeFn>) {
        ...
        fn new() -> Self {
            ...
            let editor = Arc::new(Mutex::new(CustomEditor::new(
                ...
                EditorTheme {
                    ...
                    select_list: Arc::new(
                        rpi_tui::components::select_list::SelectListTheme::identity(),
                    ),
                },
