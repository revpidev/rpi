//! Tests for the edit tool (`crates/rpi/src/tools/edit.rs`).
//!
...
fn get_text(result: &rpi_agent::types::AgentToolResult) -> String {
    result
        .content
        .iter()
...
async fn test_compute_edits_diff_enoent() {
    use rpi::tools::edit_diff::compute_edits_diff;
