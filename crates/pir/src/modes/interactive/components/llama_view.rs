...
use pir_tui::components::select_list::{SelectItem, SelectList, SelectListLayoutOptions};
use pir_tui::fuzzy::fuzzy_filter;
use pir_tui::keybindings::{get_keybindings, KeybindingsManager};
use pir_tui::tui::{Component, Focusable, RenderHandle};
...
fn select_theme(theme: &Arc<Theme>) -> Arc<pir_tui::components::select_list::SelectListTheme> {
    ...
    Arc::new(pir_tui::components::select_list::SelectListTheme {
