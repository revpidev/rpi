...
//!   typed entries.
//! - `updateNodeLabel` timestamps use the pir `now_iso8601()` helper
...
use pir_ai::types::{AssistantContent, StopReason, ToolResultContent, UserContent};
...
use pir_tui::utils::{slice_by_column, truncate_to_width, visible_width, wrap_text_with_ansi};
...
mod tests {
    ...
    use pir_agent::messages::{BashExecutionMessage, BashExecutionRole};
    ...
    fn tool_result_msg(
        ...
        msg(
            id,
            parent_id,
            AgentMessage::ToolResult(pir_ai::types::ToolResultMessage {
