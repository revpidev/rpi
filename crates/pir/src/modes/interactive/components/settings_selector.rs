...
//!   `"dark" | "light"`).
//! - `supportsImages` comes from the local `pir_tui::terminal_image::
...
use pir_agent::types::QueueMode;
use pir_ai::types::{ThinkingLevel, Transport};
use pir_tui::components::select_list::{
...
use pir_tui::terminal_image::get_capabilities;
