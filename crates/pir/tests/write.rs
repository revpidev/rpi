//! Tests for the write tool (`crates/pir/src/tools/write.rs`).
//!
//! Port of the write tool tests from `tools.test.ts:240-260`.

use pir::tools::write::{create_write_tool, WriteToolOptions};
...
async fn test_write_file_success() {
    ...
    match text {
        pir_ai::types::ToolResultContent::Text(t) => {
...
async fn test_write_byte_count_is_utf16() {
    ...
    if let pir_ai::types::ToolResultContent::Text(t) = &result.content[0] {
...
async fn test_write_and_edit_share_mutation_queue() {
    ...
    use pir::tools::edit::{create_edit_tool, EditToolOptions};
