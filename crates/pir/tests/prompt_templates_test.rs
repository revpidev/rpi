...
impl TempDir {
    fn new() -> Self {
        ...
        let dir = std::env::temp_dir().join(format!(
            "pir-prompt-templates-test-{}-{unique}",
            std::process::id()
        ));
...
fn loads_defaults_then_explicit_paths() {
    ...
    tmp.write("project/.pir/prompts/project.md", "project template");
...
fn include_defaults_false_and_relative_explicit_path() {
    ...
    tmp.write("project/.pir/prompts/project.md", "project");
