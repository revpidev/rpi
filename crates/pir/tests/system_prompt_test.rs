...
// ---------------------------------------------------------------------------
// Temp dir helper (mirrors crates/pir/src/tools.rs test_helpers::TempDir,
