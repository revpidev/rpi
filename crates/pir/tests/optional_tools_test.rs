...
use pir::tools::find::{create_find_tool, FindToolOptions};
use pir::tools::grep::{create_grep_tool, GrepToolOptions};
use pir::tools::ls::{create_ls_tool, LsToolOptions};
...
mod optional_tool_wiring {
    ...
    ) -> (pir::core::agent_session::AgentSession, TempDir) {
        let tmp = TempDir::new();
