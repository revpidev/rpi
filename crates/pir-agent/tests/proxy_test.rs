//! Contract tests for `pir_agent::proxy` (port of
...
//! (coding-standards §12.4); the server pattern mirrors the pir-ai
//! `contract_adapters` tests.

use std::time::Duration;

use futures::StreamExt;
use pir_agent::proxy::{stream_proxy, ProxyStreamOptions};
use pir_ai::types::{
...
// ---------------------------------------------------------------------------
// Scripted HTTP server (mirrors crates/pir-ai/tests/contract_adapters.rs)
// ---------------------------------------------------------------------------
