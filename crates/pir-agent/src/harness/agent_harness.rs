...
use pir_ai::utils::retry::{RetryCallbacks, RetryFinishedArgs, RetryPolicy, RetryScheduledArgs};
        ...
        Arc::new(
            move |model: Model, context: Context, options: StreamOptions| {
                ...
                futures::stream::once(async move {
                    ...
                    let on_payload: pir_ai::types::OnPayloadCallback = {
                        let this = Arc::clone(&this);
                        let shared = Arc::clone(&shared);
                    ...
                    let on_response: pir_ai::types::OnResponseCallback = {
                        let this = Arc::clone(&this);
                        let shared = Arc::clone(&shared);
