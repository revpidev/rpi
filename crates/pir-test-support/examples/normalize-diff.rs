...
//!
//! Normalizes both inputs with fresh `pir-test-support` normalizers and diffs
...
//!
//! Usage:
//!   cargo run -p pir-test-support --example normalize-diff -- <expected> <actual> [path-to-strip...]

use std::process::ExitCode;

use pir_test_support::normalize::Normalizer;
...
fn main() -> ExitCode {
    ...
    match pir_test_support::diff::diff_jsonl(&e, &a) {
        Ok(()) => {
