...
- **状态**：已采纳
- **日期**：2026-08-10
- **关联**：[ADR-0009](./0009-product-endpoints-resetpi.md)（端点自托管决策，
...
部署内容 `deploy/resetpi/`）。域名于 2026-08-10 更换为 **revpi.dev**（同一
...
（`deploy/resetpi/` 目录，wrangler 4.x 需在目录内执行部署以识别 functions）。
